...
class OutputAir:
    ...
    def analyse_output(self, results_dir: str, sequence_assembled: sequence.SequenceAssembled,
        ...
        logging.warn('Extracting the templates from the features file')
        ...
        #Use frobenius
        #logging.warn('Creating dendogram and clusters with ALEPH')
        ...
        #    logging.warn('The groups generated by frobenius are the following ones:')
        #    for i, templates in enumerate(dendogram_list):
        #        logging.warn(f'Group {i}: {" ".join(templates)}')
                

        # Generate CCANALYSIS plots, one without rankeds and another one with rankeds.

        logging.warn('Analysing results with hinges and ccanalysis')
