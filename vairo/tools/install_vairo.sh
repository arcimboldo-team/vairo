...
conda install -y -c conda-forge openmm==8.0.0 cudatoolkit==11.2 pdbfixer
...
pip install absl-py==1.0.0 biopython==1.79 chex==0.1.86 dm-haiku==0.0.12 dm-tree==0.1.8 immutabledict==2.0.0 ml-collections==0.1.0 numpy==1.24.3 scipy==1.11.1 pandas==1.3.4 tensorflow==2.16.1 tensorflow-cpu==2.16.1 matplotlib==3.6.2 python-igraph pyyaml future csb psutil paramiko scikit-learn jinja2 flask
